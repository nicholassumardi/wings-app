...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 10, 2024 at 08:35 AM
...
(4, '2024_08_09_11349_create_roles_table', 1),
(5, '2024_08_09_134901_create_user_roles_table', 1),
(6, '2024_08_09_134944_create_task_managements_table', 1);
...
ALTER TABLE `task_managements`
  ADD PRIMARY KEY (`id`),
  ADD KEY `task_managements_user_id_foreign` (`user_id`);
...
--
-- Constraints for table `task_managements`
--
ALTER TABLE `task_managements`
  ADD CONSTRAINT `task_managements_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`);
